...
def main():
	...
	#####################################################################################
	insert_league_odd("eng-premier-league",		"2022-2023")
	insert_league_odd("esp-primera-division",	"2022-2023")
	insert_league_odd("fra-ligue-1",			"2022-2023")
	insert_league_odd("ned-eredivisie",			"2022-2023")
	insert_league_odd("aut-bundesliga",			"2022-2023")
	insert_league_odd("bundesliga",				"2022-2023")
	insert_league_odd("ita-serie-a",			"2022-2023")
	insert_league_odd("por-primeira-liga",		"2022-2023")
	# insert_league_odd("gre-super-league",		"2022-2023")
	insert_league_odd("tur-sueperlig",			"2022-2023")
	insert_league_odd("nor-eliteserien",		"2022")
	insert_league_odd("swe-allsvenskan",		"2022")
	insert_league_odd("sui-super-league",		"2022-2023")
	insert_league_odd("den-superligaen",		"2022-2023")
	# insert_league_odd("ukr-premyer-liga",		"2022-2023")
	insert_league_odd("bul-parva-liga",			"2022-2023")
	insert_league_odd("cze-1-fotbalova-liga",	"2022-2023")
	insert_league_odd("cro-1-hnl",				"2022-2023")
	insert_league_odd("hun-nb-i",				"2022-2023")
	insert_league_odd("srb-super-liga",			"2022-2023")
